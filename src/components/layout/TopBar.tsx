...
export function TopBar({ user, onSearch }: TopBarProps) {
  const [notificationCount] = useState(3);

  return (
    <header
      className="flex items-center justify-between h-[var(--topbar-height)] border-b border-border bg-card px-4 md:px-6"
      role="banner"
    >
      {/* Mobile menu button */}
      <button
